// ============================================================================
// LunaCore - Preferencje UI (motyw + jezyk)
// ----------------------------------------------------------------------------
// Trwaly, drobny stan interfejsu w config/ui.local.json (gitignore) - jak
// brudnopis, zwykly plik zamiast localStorage. Trzyma tylko { theme, lang }.
...
const LANGS = ['pl', 'en'];
const DEFAULTS = { theme: 'cyberpunk', lang: 'pl' };
...
/**
 * Scala i zapisuje preferencje. Przyjmuje czesciowy obiekt { theme?, lang? }.
 * @returns {{theme:string,lang:string}|null} nowy stan lub null przy bledzie zapisu
 */
